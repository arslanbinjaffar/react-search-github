...
const UserInfo = () => {
  ...
  const items=[
    {id:1,icon:<GoRepo className='icon'/> ,label:"repo",value:public_repos,color:"pink"},
    ...
    {id:4,icon:<GoGist className='icon'/> ,label:"",value:public_gists,color:"yellow"},
  ]
  return (

    <div className="section">
  <Wrapper className='section-center'>
    {items.map(({id,color,icon,label,value})=>{
      return(
